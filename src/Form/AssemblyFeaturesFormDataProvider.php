...
/**
 * Class AssemblyFeaturesFormDataProvider
 */
class AssemblyFeaturesFormDataProvider implements FormDataProviderInterface
{
    /**
     * @var int|null
     */
    ...
    public function getData()
    {
        ...
        $obj = new FeatureValue($this->id);

        return [
            'assembly' => [
                'id'            => $obj->id,
                'name'          => (new Feature($obj->id_feature))->name[1],
                'value'         => $obj->value[1],
    ...
    public function setData(array $data): array
    {
        ...
        if (!empty($assemblyData['id'])) {
            $id = $assemblyData['id'];
            $this->repository->updateFeature($id, $assemblyData);
        }
